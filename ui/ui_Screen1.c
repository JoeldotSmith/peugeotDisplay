...
lv_img_set_src(ui_Image1, &ui_img_boost_gauge_transparent_png);
...
lv_img_set_src(ui_Image2, &ui_img_gauge_needle_png);
...
lv_obj_set_style_transform_angle(ui_Image2, -600, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_transform_pivot_x(ui_Image2, 160, LV_PART_MAIN| LV_STATE_DEFAULT);
lv_obj_set_style_transform_pivot_y(ui_Image2, 180, LV_PART_MAIN| LV_STATE_DEFAULT);
